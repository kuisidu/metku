...
BASIC_STEEL_PRICE = 1169.0

# Steel grade add-on [e/tonne]
def steel_grade_add_on(grade):
    if grade == "S235":
        return 0.0
    elif grade == "S355":
        return 35.0
...
# Mass in [kg]
def quantity_per_thicknsee_add_on(mass):
    if mass < 2000:
        return 90.0
    elif mass < 3000:
        return 90.0
